...
public class When_generating_a_Builder_with_constructor_parameters : Given_a_BuilderGenerator
{
    [Fact]
    public Task Test()
    {
        ...
        var inputCompilation = CreateCompilation(GetResourceAsString(assembly, "ExampleWithConstructor.cs"))
            .AddSyntaxTrees(CSharpSyntaxTree.ParseText(GetResourceAsString(assembly, "PersonWithConstructorBuilder.cs")));
